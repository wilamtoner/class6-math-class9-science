# -*- coding: utf-8 -*-
"""
Class 9 Unit 4 (Evolution): Complete Enhanced Interactive JavaScript Engine
"""
import sys
...
# Verify no double viramas
assert '\u094d\u094d' not in js_code, "Double virama detected in js_code!"

with open("scratch/c9u4_js.js", "w", encoding="utf-8") as f:
    f.write(js_code)

print(f"Successfully generated scratch/c9u4_js.js ({len(js_code)} bytes).")
