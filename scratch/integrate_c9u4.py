# -*- coding: utf-8 -*-
"""
Integrate Class 9 Unit 4 (Evolution) into index.html
"""
import sys

print("Reading index.html, c9u4_html.html, and c9u4_js.js ...")
...
target_html_marker = "<!-- Placeholder View for Units 4 to 19 -->"
if target_html_marker not in index_content:
    print("ERROR: target_html_marker not found!")
    sys.exit(1)

# Replacement for placeholder
new_placeholder_comment = "<!-- Placeholder View for Units 5 to 19 -->"
new_placeholder_desc = "यस एकाइको अध्ययन सामग्री तथा अभ्यास समाधान तयारीमा छ। हाल एकाइ १, एकाइ २, एकाइ ३ र एकाइ ४ पूर्ण रूपमा उपलब्ध छन्।"

index_content = index_content.replace(
    '<p id="c9-placeholder-desc" class="text-xs md:text-sm text-slate-500 mt-1 max-w-md">यस एकाइको अध्ययन सामग्री तथा अभ्यास समाधान तयारीमा छ। हाल एकाइ १, एकाइ २ र एकाइ ३ पूर्ण रूपमा उपलब्ध छन्।</p>',
    f'<p id="c9-placeholder-desc" class="text-xs md:text-sm text-slate-500 mt-1 max-w-md">{new_placeholder_desc}</p>'
)

# Insert c9u4_html before placeholder view
index_content = index_content.replace(target_html_marker, f"{c9u4_html}\n\n      {new_placeholder_comment}")
...
index_content = index_content.replace(target_js_marker, f"{c9u4_js}\n\n  {target_js_marker}")

# 3. Update switchGrade9Unit to include v4
...
with open("index.html.bak_before_c9u4", "w", encoding="utf-8") as f:
...
print(f"Successfully integrated C9U4 into index.html! New length: {len(index_content)} bytes")
