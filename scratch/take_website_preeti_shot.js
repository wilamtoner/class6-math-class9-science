...
async function shot() {
  const chrome = spawn('chromium', [
    ...
    '--user-data-dir=/tmp/cdp_shot_full_' + Date.now(),
  ...
  fs.writeFileSync('/tmp/website_preeti_default.png', Buffer.from(shotRes.data, 'base64'));
  console.log('Screenshot saved to /tmp/website_preeti_default.png');
