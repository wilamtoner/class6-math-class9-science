...
async function shot() {
  const chrome = spawn('chromium', [
    ...
    '--user-data-dir=/tmp/cdp_shot_' + Date.now(),
  ...
  fs.writeFileSync('/tmp/preeti_modal.png', Buffer.from(shotRes.data, 'base64'));
  console.log('Screenshot saved to /tmp/preeti_modal.png');
